...
open class WordsToPhrasesLesson(override val name: String, val p: Productions, val letters: List<Letter>, val words: List<Translation>, val phraseProductions: List<Pair<(Translation) -> Translation, List<Translation>>>, override var dependencies: List<Lesson> = listOf()) : Lesson {
